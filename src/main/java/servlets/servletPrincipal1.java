 ...
 * @author David
 */
@WebServlet(name="servletPrincipal1", urlPatterns={"/servletPrincipal1"})
public class servletPrincipal1 extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet servletPrincipal1</title>");  
            out.println("</head>");
            out.println("<body>");
